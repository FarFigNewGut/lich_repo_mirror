...
#  Coraesine_Old: /Coraesine_Old/,
  ...
  Lightning_Flare: /\*\* Your .*? emits? a searing bolt of lightning|Gathering around your .*?, a pulsating light grows in intensity until a shocking eruption of energized power scorches|Filling the air with static electricity, bright white and orange ghosts rise out of your .*? and sail through the air, passing in and out of .*? before dissipating with a low moan/,
