...
FLARE_PATTERNS = {
  ...
  Animal: /slender tendrils rising up to coalesce into the ethereal form/,
  ...
  Feral_Totem: /totem/,
  Blink: /suddenly lights? up with hundreds of tiny blue sparks/,
  ...
  Dramatic_Drapery: /distorts the air around you, confounding an/,
  ...
  GuidingLight_2nd: /Your .* sprays? with a burst of plasma energy!/,
  ...
  Parasite_Weapon: /You wince as .* draws upon your blood as it strikes/,
  ...
  Sonic_Weapon_1st: /Your .* unleashes? a blast of sonic energy at/,
  Sonic_Weapon_2nd: /With a loud snap, a blast of energy bursts from your .*/,
  Spore: /Nebulous .* tendrils curl from your .*, enswathing .* in a shroud spangled with .* spores/,
  Sprite_Weapon: /You feel a slight sting as the sprite draws upon your power to attack/,
  ...
  Valence_Weapon: /A coil of spectral .* energy bursts? out of thin air|A coil of ghostly .* energy bursts? out of thin air|A coil of eerie .* energy bursts? out of thin air|A coil of celestial .* energy bursts? out of thin air/,
