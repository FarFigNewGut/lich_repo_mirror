...
DMGFLARE_PATTERNS = {
  ...
  Dispel_ChaoticFlux: /fluxes chaotically/,
  ...
  Vethinye: /As a resonating song emanates? from your .*, it entwines you in night blue wisps of ephemera|As you coax a resonating song from your/,
  ...
  BS_DivineBulwark: /BS_DivineBulwark/
}
